...
public class ExecriseFragment extends BaseFragment<BreathPresenter> {
    ...
    protected void initView(View view) {
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ((BaseActivity)getActivity()).switchFragment(R.id.fragment_container,new BreathFragment(),true);
            }
        });
    }
